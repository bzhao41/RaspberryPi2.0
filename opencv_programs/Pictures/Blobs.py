...
def findBlobs(img, min_color, max_color, window, renderedwindow, location, area, ratio = 1):
...
def findRGBBlobs(img, color, window, rendered, location, area, ratio, bounds = 20):
    R = int(color[0]) 
    G = int(color[1])
    B = int(color[2])
